# PowerShell script to update McHs Package Builder Docker Image
#
# Usage example:
#
# .\scripts\update-docker.ps1

Set-Variable -Name CONTAINER -Value "mchs-package-builder"
Set-Variable -Name IMAGE -Value "mchsapp/package-builder"
