...
PACKAGES+=" clang"		# Required for mchs-elf-cleaner and C/C++ packages.
PACKAGES+=" file"		# Used in mchs_step_massage().
PACKAGES+=" gnupg"		# Used in mchs_get_repo_files() and build-package.sh.
