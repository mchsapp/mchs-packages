...
MCHS_PKG_VERSION=16.14.0
MCHS_PKG_SRCURL=https://nodejs.org/dist/v${MCHS_PKG_VERSION}/node-v${MCHS_PKG_VERSION}.tar.xz
MCHS_PKG_SHA256=05eb64193e391fa8a2c159c0f60c171824715165f80c67fcab9dbc944e30c623
