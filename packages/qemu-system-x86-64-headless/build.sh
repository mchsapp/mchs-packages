MCHS_PKG_HOMEPAGE=https://www.qemu.org
MCHS_PKG_DESCRIPTION="A generic and open source machine emulator and virtualizer (headless)"
MCHS_PKG_LICENSE="LGPL-2.1"
MCHS_PKG_MAINTAINER="@mchs"
MCHS_PKG_VERSION=1:6.1.0
MCHS_PKG_REVISION=9
MCHS_PKG_SRCURL=https://download.qemu.org/qemu-${MCHS_PKG_VERSION:2}.tar.xz
MCHS_PKG_SHA256=eebc089db3414bbeedf1e464beda0a7515aad30f73261abc246c9b27503a3c96
MCHS_PKG_DEPENDS="glib, libbz2, libc++, libcurl, libgnutls, libiconv, libjpeg-turbo, liblzo, libnettle, libnfs, libpixman, libpng, libspice-server, libssh, libusb, libusbredir, ncurses, pulseaudio, qemu-common, resolv-conf, zlib, zstd"

# Required by configuration script, but I can't find any binary that uses it.
MCHS_PKG_BUILD_DEPENDS="libtasn1"

MCHS_PKG_CONFLICTS="qemu-system-x86_64-headless"
MCHS_PKG_REPLACES="qemu-system-x86_64-headless"
MCHS_PKG_PROVIDES="qemu-system-x86_64-headless"
...
mchs_step_post_make_install() {
	...
	for i in aarch64 arm i386 riscv32 riscv64 x86_64; do
		ln -sfr \
			"${MCHS_PREFIX}"/share/man/man1/qemu.1 \
			"${MCHS_PREFIX}"/share/man/man1/qemu-system-${i}.1
	done
}
