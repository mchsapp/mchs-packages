...
char H5libhdf5_settings[]=
	...
	"             Installation point: /data/data/com.mchs/files/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	...
	"                       Archiver: /data/data/com.mchs/files/usr/bin/ar\n"
	"                         Ranlib: /data/data/com.mchs/files/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: yes\n"
	"                     C Compiler: /data/data/com.mchs/files/usr/bin/cc 7.0.0\n"
	"                       CPPFLAGS: \n"
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS: -std=c99 \n"
	...
	"\n"
	"                            C++: ON\n"
	"                   C++ Compiler: /data/data/com.mchs/files/usr/bin/c++ 7.0.0\n"
	"                      C++ Flags: \n"
	"                   H5 C++ Flags: \n"
	"                   AM C++ Flags: \n"
	"             Shared C++ Library: YES\n"
