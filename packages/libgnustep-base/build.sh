...
MCHS_PKG_DESCRIPTION="A library of general-purpose, non-graphical Objective C objects"
MCHS_PKG_LICENSE="GPL-2.0, LGPL-2.1"
MCHS_PKG_MAINTAINER="@mchs"
MCHS_PKG_VERSION=1.28.0
MCHS_PKG_REVISION=1
MCHS_PKG_SRCURL=http://ftp.gnustep.org/pub/gnustep/core/gnustep-base-${MCHS_PKG_VERSION}.tar.gz
MCHS_PKG_SHA256=c7d7c6e64ac5f5d0a4d5c4369170fc24ed503209e91935eb0e2979d1601039ed
MCHS_PKG_DEPENDS="gnustep-make, libc++, libffi, libgmp, libgnutls, libiconv, libicu, libxml2, libxslt, zlib"
MCHS_PKG_BUILD_IN_SRC=true
MCHS_PKG_EXTRA_CONFIGURE_ARGS="
--with-default-config=$MCHS_PREFIX/etc/GNUstep/GNUstep.conf
--enable-procfs
